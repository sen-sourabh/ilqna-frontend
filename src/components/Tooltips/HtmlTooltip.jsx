        ...
        <div className='qna-user-data'>
            <div className='qna-user-image'>
                <StyledBadge
                    ...
                    variant="dot"
                >
                    <Avatar className='qna-user-image' sx={{ bgcolor: generateRandomColor() }}>{ userData?.username[0]?.toUpperCase() }</Avatar>
                </StyledBadge>
            </div>
            <div className='qna-user-info'>
                <Typography variant='subtitle2'><b>{ capitalizeFirstLetter(userData?.username) }</b></Typography>
