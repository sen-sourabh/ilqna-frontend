...
export const fetchAllAnswersByQuestionId = async (body) => {
  return await axios
    .post(ENV.API_URL + 'questions/getAllAnswersByQuestionId', body, prepareHeaders())
    .then((response) => {
      checkJWT(response);
...
export const getAllAnswersCountOfUser = async (_id) => {
  return await axios
    .get(ENV.API_URL + `answers/getAllAnswersCountOfUser?answerUserId=${_id}`, prepareHeaders())
    .then((response) => {
      checkJWT(response);
      return refactor(response);
    })
...
export const addAnswer = async (body) => {
  return await axios
    .post(ENV.API_URL + 'answers/addAnswer', body, prepareHeaders())
    .then((response) => {
      checkJWT(response);
      return refactor(response);
    })
...
export const updateAnswer = async (body) => {
  return await axios
    .put(ENV.API_URL + 'answers/updateAnswer', body, prepareHeaders())
    .then((response) => {
      checkJWT(response);
      return refactor(response);
    })
